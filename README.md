...
You can find the latest APK in the [Releases](https://github.com/mdaksh/M3uVideoPlayer/releases) section.

---
*Note: This application does not provide any content. You must provide your own M3U playlist or Xtream Codes credentials.*
